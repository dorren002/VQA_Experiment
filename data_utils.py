...
class ExStreamFixedBufferRehearsalBatchSampler(torch.utils.data.Sampler):
    def __init__(self, buffer_size, buffer_replacement_strategy):
        self.buffer_size = buffer_size
        # A dictionary from class id to
        self.per_class_rehearsal_ixs = {}
        self.buffer_replacement_strategy = buffer_replacement_strategy
